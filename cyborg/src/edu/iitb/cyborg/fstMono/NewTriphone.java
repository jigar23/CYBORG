...
import edu.iitb.cyborg.Fileloader.FilesLoader;
	...
	public class NewTriphone {
		...
		public static void main(String[] args) throws Exception {
			...
			//----- create the FST file----//
			Fst.getFST("gahuu jvaarii", "resources//fillerDict.txt");
			//--Read the FST file--//
...
//					System.out.println(trArray.size());
		 ...
		 * @throws Exception 
		 */
		ArrayList<NewTriphone>  getStartTriphone() throws Exception{
		 ...
		 * @throws Exception 
		 */
		public ArrayList<NewTriphone> getStartState() throws Exception {
		 ...
		 * @throws Exception 
		 */
		public ArrayList<NewTriphone> getNextState(NewTriphone t) throws Exception {
			ArrayList<NewTriphone> list = new ArrayList<>();
			FilesLoader fl = new FilesLoader();
			int states[];
...
//					return list;
		 ...
		 * @throws Exception 
		 */
		ArrayList<NewTriphone> getNextTriphone(NewTriphone tr) throws Exception{
