...
//			else
	 ...
	 * @return
	 */
	public ArrayList<Monophone> getStartState() throws TriphoneDoesntExistsException {
	 ...
	 * @return
	 */
	ArrayList<Monophone> getNextTriphone(Monophone mn) throws TriphoneDoesntExistsException{
	 ...
	 * @throws IOException
	 */
	public ArrayList<Monophone> getNextState(Monophone m) throws IOException, TriphoneDoesntExistsException {
		ArrayList<Monophone> list = new ArrayList<>();
		FilesLoader fl = new FilesLoader();
		int states[] = fl.getStates(m.getTriphone());
